...
const char* KEY = "J6E3TlJwEIWsZWpuabIkU5TC0cMaldFVyY2lIJrwy6E=";    // event hub access key 
const char* KEY_NAME = "RootManageSharedAccessKey";                 // event hub key name  ( policy name) 
const char* HOST = "technosal.servicebus.windows.net";              // event hub name (name of service bus)
...
// START: WiFi settings
const char* SSID = "TP-LINK_82A4";
const char* PASSWORD = "winteriscoming@2021";
// END: WiFi settings
String request;
String data;
String fullSas;
